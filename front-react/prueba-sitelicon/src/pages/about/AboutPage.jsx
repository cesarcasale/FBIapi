      ...
      <div className='row'>
        <div className='col py-5'>
          <p className=' text-center'>
            ...
            independientemente de la tecnología utilizada, pero luego, despues de considerar las 
            ventajas de demostrar 
            mi experiencia con una tecnología más avanzada, decidí implementarlo con React. <br />
            ...
            valor agregado importante.<br />
            Tuve problemas al hacer el filtro por sexo, con lo cual lo deje comentado en el codigo para que puedan ver hasta 
            donde pude llegar y cuales fueron mis errores.<br />
            </p>
            <p>
            ...
            Mi objetivo es aprovechar al máximo esta experiencia para ampliar mis conocimientos, 
            mientras contribuyo de manera significativa al equipo. Estoy comprometido a trabajar duro y de manera eficiente, para
          ...
          <p>Gracias por su tiempo, y por darme la oportunidad de formar parte de la empresa</p>
        </div>
      </div>
      <Footer></Footer>
    </div>
